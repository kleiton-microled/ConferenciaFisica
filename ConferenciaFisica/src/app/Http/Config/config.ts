...
//export const BASE_IMAGES = 'https://localhost:5000';
export const BASE_IMAGES = 'https://api-conferenciafisica.bandeirantesdeicmar.com.br';
//export const DESCARGA_EXPORTACAO_URL = 'https://localhost:5000/api/descarga-exportacao';
export const DESCARGA_EXPORTACAO_URL = 'https://api-conferenciafisica.bandeirantesdeicmar.com.br/api/descarga-exportacao';
export const DESCARGA_UTIL_URL = 'https://api-conferenciafisica.bandeirantesdeicmar.com.br/tipos-processo-foto';
