...
export const BASE_IMAGES = 'http://api-conferenciafisicadev.deicmar.srv';
export const DESCARGA_EXPORTACAO_URL = 'http://api-conferenciafisicadev.deicmar.srv/api/descarga-exportacao';
